...
from Templating.BackTestCommon import Exec_Buy, Exec_Sell, START_TRADING_ON, NO_OF_SHARES_KEY, CASH_KEY,CASH_VALUE 
...
data.to_csv(resultFolderPath + '\\BT_MACD_Only.csv')
summary.to_csv(resultFolderPath + '\\BT_MACD_Only_Sum.csv')
